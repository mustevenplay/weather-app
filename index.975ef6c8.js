...
function colorsByWeatherCode(code) {
    ...
    else if (code == 45 || code == 48) return [
        "lightgray",
        "lightblue"
    ];
    else if (code == 51 || code == 53 || code >= 55 && code <= 57 || code == 61 || code == 63 || code >= 65 && code <= 67 || code == 71 || code == 73 || code >= 75 && code <= 77 || code == 85 || code == 86) return [
        "lightgray",
        "snow"
    ];
    else if (code == 95 || code == 96 || code == 99) return [
        "gray",
        "lightgray"
    ];
}
...
async function checkLocation(latitude, longitude) {
    try {
        ...
        if (locationDataObj.display_name == undefined) return [
            undefined,
            undefined
        ];
        let city;
...
function updateWeatherData() {
    ...
    fetch(url).then((response)=>response.json()).then(async (obj)=>{
...
},{}]},["au4Ql","8lqZg"], "8lqZg", "parcelRequirebbde")
